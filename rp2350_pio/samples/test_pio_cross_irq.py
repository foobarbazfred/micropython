#
# synchronize state machines cross PIO 
#  sm:0 in PIO:1  ->  sm:1 in PIO:0
#
...
def main():
    ...
    sm4 = rp2.StateMachine(4, inst_nop, freq=2000)
    ...
    print('start sm_1 only')
    sm1.active(1)
    for _ in range(3):
        print('send IRQ(5) from sm_4 (PIO:1/SM:0) to sm_1 (PIO:0/SM:1)')
        sm4.exec(0xc00d)        # IRQ(5) 1100...0101  + IdxMode:01 -> 1100.....1101
        time.sleep(0.5)
    print('stop sm_1')    
    print('bye')    
