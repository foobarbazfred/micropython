#
# Test program for DVI signal generation (V0.03)  2026/7/26
#
#  (1) Adjusted system clock to 126 MHz
#  (2) Generates HSYNC/VSYNC and fills the display area with a solid color
#  (3) Uses two DMA channels that trigger each other
#  (4) Resets the start address in software via IRQ
#
...
def init_vga_data():
    ...
    for _ in range(VGA_HEIGHT):
        ...
        index += 1
        buffer[index] = 0b00_0100100101_0011010010_1010010100
        index += 1
